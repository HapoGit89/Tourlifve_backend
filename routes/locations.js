...
/** POST / => {name, country, city, postal_code, street, housenumber, googleplaces_id, lat, lng} => { location: {id, name, country, city, postal_code, street, number, info, googleplaces_id} }
 *
